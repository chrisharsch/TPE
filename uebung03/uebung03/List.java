...
public interface List<T> extends Iterable<T> {
	 ...
	 * 
	 * @param e
	 *            Element, das hinzugef ̈ugt werden soll. * 
	 * @return ist immer true
	 */
	public abstract boolean add(T e);

	/**
	 * F ̈ugt am Anfang ein Element hinzu. *
	 * 
	 * @param e
	...
	/**
	 * ̈Uberpr ̈uft, ob Elemente vorhanden sind.
	 * 
	...
	/**
	 * Entfernt das erste Element und liefert es zur ̈uck. *
	 * 
	 * @return das erste Element
	 */
